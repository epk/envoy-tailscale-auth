...
require (
	buf.build/gen/go/envoyproxy/envoy/bufbuild/connect-go v1.4.1-20230108150232-8c3604e23c1a.1
	buf.build/gen/go/envoyproxy/envoy/protocolbuffers/go v1.28.1-20230108150232-8c3604e23c1a.4
