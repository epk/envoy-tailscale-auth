module github.com/epk/envoy-tailscale-auth

go 1.19

require (
	buf.build/gen/go/envoyproxy/envoy/bufbuild/connect-go v1.5.0-20230128150242-d71f8ec35f44.1
	buf.build/gen/go/envoyproxy/envoy/protocolbuffers/go v1.28.1-20230128150242-d71f8ec35f44.4
