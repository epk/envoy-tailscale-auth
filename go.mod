...
require (
	buf.build/gen/go/envoyproxy/envoy/bufbuild/connect-go v1.5.1-20230206150250-3c896b815fc1.1
	buf.build/gen/go/envoyproxy/envoy/protocolbuffers/go v1.28.1-20230206150250-3c896b815fc1.4
