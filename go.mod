...
require (
	buf.build/gen/go/envoyproxy/envoy/bufbuild/connect-go v1.4.1-20230121150242-e8d97ed6ffa4.1
	buf.build/gen/go/envoyproxy/envoy/protocolbuffers/go v1.28.1-20230121150242-e8d97ed6ffa4.4
