...
var (
	...
	shutdownTimeout  = pflag.Duration("shutdown-timeout", defaultShutdownTimeout, "timeout to wait for the server to shutdown")
)
...
func main() {
	...
	if err != nil {
		log.Fatal(err) //nolint: gocritic // at this point we don't care about canceling the context
	}
}
